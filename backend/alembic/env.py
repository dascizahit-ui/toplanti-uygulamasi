...
config.set_main_option("sqlalchemy.url", ayarlar.veritabani_baglanti_url)

if config.config_file_name is not None:
    fileConfig(config.config_file_name)

target_metadata = TemelModel.metadata


def run_migrations_offline() -> None:
    """Çevrimdışı migration çalıştır."""
...
async def run_async_migrations() -> None:
    ...
    section["sqlalchemy.url"] = ayarlar.veritabani_baglanti_url
